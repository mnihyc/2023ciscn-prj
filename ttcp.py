...
class TTcp:
    ...
    def __str__(self):
        return f'TCP: {self.ok} acc={self.accessible} port={self.port} {" ".join(self.protocol)} {self.honeypot} {self.device}'
